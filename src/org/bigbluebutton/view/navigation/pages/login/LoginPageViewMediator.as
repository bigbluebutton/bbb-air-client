	...
	public class LoginPageViewMediator extends Mediator
	{
		...
		public function onInvokeEvent(invocation:InvokeEvent):void 
		{
			...
			if(Capabilities.isDebugger)
			{
				...
				url="bigbluebutton://142.204.133.100/bigbluebutton/api/join?fullName=Air&meetingID=random-6798773&password=ap&checksum=31f28ca0415f85ebed7d50d6925cede64f7aa81d";
