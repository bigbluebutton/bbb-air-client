	...
	public class LoginPageViewMediator extends Mediator
	{
		...
		public function onInvokeEvent(invocation:InvokeEvent):void 
		{
			...
			if(Capabilities.isDebugger)
			{
				...
				url = "bigbluebutton://142.204.133.88/bigbluebutton/api/join?fullName=Adam-Air&meetingID=Demo+Meeting&password=ap&checksum=0673faf71bd60ac50e41057d414cbada96c1e93a";
